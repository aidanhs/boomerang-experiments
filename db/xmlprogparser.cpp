...
void XMLProgParser::start_userproc(const char **attr)
{
    ...
    if (address)
        proc->decoded = atoi(address);
    address = getAttr(attr, "analysed");
    if (address)
        proc->analysed = atoi(address);
    address = getAttr(attr, "decompileSeen");
    if (address)
        proc->decompileSeen = atoi(address);
    address = getAttr(attr, "decompiled");
    if (address)
        proc->decompiled = atoi(address);
    address = getAttr(attr, "isRecursive");
    if (address)
        proc->isRecursive = atoi(address);
    address = getAttr(attr, "firstCallerAddress");
    if (address)
...
void XMLProgParser::addToContext_param(Context *c, int e)
{
    ...
    switch(e) {
        case e_type:
            ...
            break;
        case e_loc:
            c->param->setLoc(stack.front()->loc);
            break;
        default:
            if (e == e_unknown)
...
void XMLProgParser::addToContext_implicitparam(Context *c, int e)
{
    ...
    switch(e) {
        case e_type:
            ...
            break;
        case e_loc:
            c->implicitParam->setLoc(stack.front()->loc);
            break;
        default:
            if (e == e_unknown)
...
void XMLProgParser::start_bb(const char **attr)
{
    ...
    if (str)
        bb->m_labelneeded = atoi(str);
    str = getAttr(attr, "incomplete");
    if (str)
        bb->m_bIncomplete = atoi(str);
    str = getAttr(attr, "jumpreqd");
    if (str)
        bb->m_bJumpReqd = atoi(str);
    str = getAttr(attr, "m_traversed");
    if (str)
        bb->m_iTraversed = atoi(str);
...
void XMLProgParser::addToContext_assign(Context *c, int e)
{
    ...
    switch(e) {
        case e_lhs:
            assign->setLeft(stack.front()->loc);
            break;
        case e_rhs:
...
void XMLProgParser::addToContext_callstmt(Context *c, int e)
{
    ...
    switch(e) {
        ...
        case e_argument:
            ...
            break;
        case e_returnexp:
            call->addReturn(stack.front()->loc);
            break;
        default:
            if (e == e_unknown)
...
void XMLProgParser::addToContext_returnstmt(Context *c, int e)
{
    ...
    switch(e) {
        case e_returnexp:
            ret->returns.push_back(stack.front()->loc);
            break;
        default:
            if (e == e_unknown)
...
void XMLProgParser::persistToXML(std::ostream &out, Signature *sig)
{
    ...
    for (unsigned i = 0; i < sig->params.size(); i++) {
        ...
        out << "</type>\n";
        out << "<loc>\n";
        persistToXML(out, sig->params[i]->getLoc());
        out << "</loc>\n";
        out << "</param>\n";
    }
    for (unsigned i = 0; i < sig->implicitParams.size(); i++) {
        ...
        out << "</type>\n";
        out << "<loc>\n";
        persistToXML(out, sig->implicitParams[i]->getLoc());
        out << "</loc>\n";
        out << "</implicitparam>\n";
    }
    for (unsigned i = 0; i < sig->returns.size(); i++) {
        ...
        out << "</type>\n";
        out << "<loc>\n";
        persistToXML(out, sig->returns[i]->getLoc());
        out << "</loc>\n";
        out << "</return>\n";
    }
    if (sig->rettype) {
