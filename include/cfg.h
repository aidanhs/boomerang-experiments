...
private:
		 ...
		 * The first node's type becomes fall-through and ends at the RTL prior to that associated with uNativeAddr.
		 * The second node's type becomes the type of the original basic block (pBB), and its out-edges are those of
