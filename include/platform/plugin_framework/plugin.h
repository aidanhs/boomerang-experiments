...
typedef int32_t (*PF_RegisterFunc)(const char * nodeType, const PF_RegisterParams * params);
typedef int32_t (*PF_InvokeServiceFunc)(const char * serviceName, void * serviceParams);
