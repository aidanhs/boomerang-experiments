...
#include "plugin_interfaces/loader_interface.h"
#include "plugin_interfaces/loader_services.h"
// Adapter pattern, provides convenience wrapping of platform
// services, and passes exceptions up to the boomerang
template<class Wrapped,class Interface>
